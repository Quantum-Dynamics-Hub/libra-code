...
set1 = [
    [[[1.0 + 0.0j, 0.5 + 0.3j], [0.5 - 0.3j, 1.5 + 0.0j]], 1.0e+20, 1.0, 0.1, 0,
        [[0.0, 0.5], [0.5, 0.0]]],  # When Ekin -> \infty, rates = |\Delta E| / \hbar
    [[[1.0 + 0.0j, 0.5 + 0.3j], [0.5 - 0.3j, 2.5 + 0.0j]], 1.0, 1.0,
        0.1, 0, [[0.0, 1.3636363636363636], [1.3636363636363636, 0.0]]],
    [[[2.0 + 0.0j, 1.0 + 0.2j], [1.0 - 0.2j, 3.0 + 0.0j]], 1.0, 1.0,
        0.1, 0, [[0.0, 0.9090909090909091], [0.9090909090909091, 0.0]]],
...
set2 = [
    [[[1 / math.sqrt(2)], [1 / math.sqrt(2)]], [[0.0, 1.3636363636363636], [1.3636363636363636, 0.0]],
     [[1.466666666666667], [1.466666666666667]]],  # equal populations
    [[[0.8 + 0.1j], [0.6 - 0.2j]], [[0.0, 1.3636363636363636], [1.3636363636363636, 0.0]],
        [[1.8333333333333335], [1.128205128205128]]],
    [[[0.8 + 0.1j], [0.6 - 0.2j]], [[0.0, 0.9090909090909091], [0.9090909090909091, 0.0]],
        [[2.7500000000000000], [1.6923076923076918]]],
]
