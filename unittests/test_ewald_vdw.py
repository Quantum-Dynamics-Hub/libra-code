...
class Test_Ewald_VdW(unittest.TestCase):
    ...
    def test_1(self):
        ...
        R.append(a * VECTOR(0.0, 0.0, 0.0))
        F.append(VECTOR(0.0, 0.0, 0.0))    # Na
        R.append(a * VECTOR(0.5, 0.5, 0.0))
        F.append(VECTOR(0.0, 0.0, 0.0))    # Na
        R.append(a * VECTOR(0.5, 0.0, 0.5))
        F.append(VECTOR(0.0, 0.0, 0.0))    # Na
        R.append(a * VECTOR(0.0, 0.5, 0.5))
        F.append(VECTOR(0.0, 0.0, 0.0))    # Na

        R.append(a * VECTOR(0.5, 0.0, 0.0))
        F.append(VECTOR(0.0, 0.0, 0.0))    # Cl
        R.append(a * VECTOR(0.0, 0.5, 0.0))
        F.append(VECTOR(0.0, 0.0, 0.0))    # Cl
        R.append(a * VECTOR(0.0, 0.0, 0.5))
        F.append(VECTOR(0.0, 0.0, 0.0))    # Cl
        R.append(a * VECTOR(0.5, 0.5, 0.5))
        F.append(VECTOR(0.0, 0.0, 0.0))    # Cl
