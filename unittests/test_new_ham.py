...
class Test_New_Hamiltonian(unittest.TestCase):
    ...
    def test_7(self):
        ...
        Hdia = CMATRIX(2, 2)
        Hdia.set(0, 0, 1.0 + 0.0j)
        Hdia.set(0, 1, 0.1 + 0.0j)
        Hdia.set(1, 0, 0.1 + 0.0j)
        Hdia.set(1, 1, 1.0 + 0.0j)
    ...
    def test_8(self):
        ...
        for i in [0]:
            ...
            #  d Hdia / dR_0
            d1ham_dia[i].set(0, 0, 1.0 + 0.0j)
            d1ham_dia[i].set(0, 1, 0.1 + 0.0j)
            d1ham_dia[i].set(1, 0, 0.1 + 0.0j)
            d1ham_dia[i].set(1, 1, -1.1 + 0.0j)

            #  <dia| d/dR_0| dia >
            dc1_dia[i].set(0, 0, 0.0 + 0.0j)
            dc1_dia[i].set(0, 1, 0.1 + 0.0j)
            dc1_dia[i].set(1, 0, -0.1 + 0.0j)
            dc1_dia[i].set(1, 1, 0.0 + 0.0j)
        ...
        for i in [0]:
            print "Adi dE/dR =  "
            d1ham_adi[i].show_matrix()
            print "Adi D = "
            dc1_adi[i].show_matrix()
    ...
    def test_10(self):
        ...
        Cadi.set(1, 1.0 + 0.0j)
        tmp = U * Cadi
        Cdia.set(0, tmp.get(0))
        Cdia.set(1, tmp.get(1))
...
#        tmp = U.H() * Sdia * Cdia;   Cadi.set(0, tmp.get(0)); Cadi.set(1, tmp.get(1));
        ...
        print "d1ham_dia = "
        d1ham_dia[0].show_matrix()
        print "d1ham_adi = "
        d1ham_adi[0].show_matrix()
        print "dc1_dia = "
        dc1_dia[0].show_matrix()
        print "dc1_adi = "
        dc1_adi[0].show_matrix()
        ...
        print "Forces dia = "
        (Cdia.H() * f_dia1[0] * Cdia / nrm_dia).show_matrix()
        print "Forces adi = "
        (Cadi.H() * f_adi1[0] * Cadi / nrm_adi).show_matrix()
