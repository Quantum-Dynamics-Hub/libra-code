...
//  = &nHamiltonian::QTSH_forces_dia;
  ...
  double beta, double eta, double a, double b, double c) = &nHamiltonian::kcrpmd_effective_potential;

  MATRIX (nHamiltonian::*expt_kcrpmd_effective_force_v1)
  (vector<double>& y_aux_var, const MATRIX& q, const MATRIX& invM, 
  double beta, double eta, double a, double b, double c) = &nHamiltonian::kcrpmd_effective_force;

  vector<double> (nHamiltonian::*expt_kcrpmd_effective_auxiliary_force_v1)
  (vector<double>& y_aux_var, 
  double beta, double eta, double a, double b, double c) = &nHamiltonian::kcrpmd_effective_auxiliary_force;
