...
def run_step2_jobs(params):
    ...
    for njob in range(njobs):
        ...
        if es_software.lower() == "cp2k":
            ...
            Gaussian_methods.gaussian_distribute(
                job_init_step,
                job_final_step,
                nsteps_this_job,
                trajectory_xyz_filename,
            ...
            DFTB_methods.dftb_distribute(
                job_init_step,
                job_final_step,
                nsteps_this_job,
                trajectory_xyz_filename,
                es_software_input_template,
                waveplot_input_template,
                njob)
...
if __name__ == '__main__':
    params = {
        ...
        "ncores": 32,
        "memory": 50000,
        "mail": "bsmith24@buffalo.edu",
        "min_band": 28,
        "max_band": 29,
        "homo_index": 28,
        "project_name": "c10h16",
        "trajectory_xyz_filename": "c10h16.xyz",
        "path": "/panasas/scratch/grp-alexeyak/brendan/active_projects/libra_development/test_black_box",
        "es_software": "cp2k",
