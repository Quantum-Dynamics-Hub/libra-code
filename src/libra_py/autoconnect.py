...
def autoconnect(R, MaxCoord, params):
    ...
    for it in unsorted_pairs:
        unsorted_pairs_out.append([mapping[it[0]][0], mapping[it[0]][1], VECTOR(0.0, 0.0, 0.0), VECTOR(
            periodicity[it[0]][0] * tv1 + periodicity[it[0]][1] * tv2 + periodicity[it[0]][2] * tv3)])
...
class TestAutoconnect(unittest.TestCase):
    ...
    def test_1(self):
        ...
        MaxCoord.append(1)  # Atom 1
        R.append(VECTOR(1.0, 0.0, 0.0))
        MaxCoord.append(1)  # Atom 2
    ...
    def test_2(self):
        ...
        MaxCoord = []
        R.append(VECTOR(0.0, 0.0, 0.0))
        MaxCoord.append(2)  # Atom 1
        R.append(VECTOR(1.0, 0.0, 0.0))
        MaxCoord.append(2)  # Atom 2
        R.append(VECTOR(1.2, 0.0, 0.0))
        MaxCoord.append(2)  # Atom 2
