...
def plot_mem(res, _params, model_params, plot_params):
    ...
    if "pop_adi" in properties_to_save and t is not None:
    ...
    if "pop_dia" in properties_to_save and t is not None:
        for i in range(nstates):
    ...
    if "norm_dia" in properties_to_save and "norm_adi" in properties_to_save and t is not None:
