...
def load(dyn_general):
    ...
    dyn_general.update({"momenta_rescaling_algo":211 })  # accept and rescale based on force differences, reverse on frustrated
    ...
    dyn_general.update({ "decoherence_algo":0}) 
