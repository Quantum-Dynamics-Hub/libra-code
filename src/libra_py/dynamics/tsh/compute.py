...
def run_dynamics(_q, _p, _iM, _Cdia, _Cadi, _projectors, _states, _dyn_params, compute_model, _model_params, rnd):
    ...
    Args:
        ...
        dyn_params ( dictionary ): parameters controlling the execution of the dynamics
            ...
            * **dyn_params["hop_acceptance_algo"]** ( int ): selects the hop acceptance scheme:

                - 0: accept all [ default ]
            ...
            * **dyn_params["momenta_rescaling_algo"]** ( int ): selects how to change the nuclear dynamical variables after successful or frustrated hops:
            ...
            * **dyn_params["instantaneous_decoherence_variant"]** ( int ): instantaneous decoherence approach options:
            ...
            * **dyn_params["collapse_option"]** ( int ): the wfc collapse options:
            ...
            * **dyn_params["decoherence_times_type"]** ( int ): option for obtaining decoherence times:

                - 0: use energy-based dephasing times [ default ]
                - 1: use user-provided dephasing times (from decoherence_rates)


            * **dyn_params["dephasing_informed"]** ( int ): option for calculating decoherence times from energy gaps:
