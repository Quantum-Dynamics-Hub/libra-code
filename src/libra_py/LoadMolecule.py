...
# p - means 'Pattern'
    ...
    if format == "pdb":
        ...
        Atom_Record = pAtom_keyword + pAtom_id + pElement_name + pAtom_mol + \
            pAtom_chain + pAtom_id1 + pX_val + pY_val + pZ_val + pAtom_occ + pAtom_charge
    elif format == "true_pdb2":
        Atom_Record = pAtom_keyword1 + pAtom_id + pAtom_element + pAtom_mol + \
            pAtom_chain + pAtom_id1 + pX_val + pY_val + pZ_val + pAtom_occ + pAtom_charge
    elif format == "xyz":
        Atom_Record = pElement_name + pX_val + pY_val + pZ_val
    elif format == "iqmol_pdb":
        Atom_Record = pAtom_keyword + pAtom_id + pElement_name + pAtom_chain + \
            pAtom_id1 + pX_val + pY_val + pZ_val + pAtom_occ + pAtom_charge + pAtom_name
