...
# p - means 'Pattern'
    ...
    MMFF94_Angle_Type_Record1 = pX_type_index + pAtom1_ff_int_type + \
        pAtom2_ff_int_type + pAtom3_ff_int_type + pAngle_k_angle + pAngle_theta_eq
    MMFF94_Angle_Type_Record2 = pX_type_index + pAtom1_ff_int_type + \
        pAtom2_ff_int_type + pAtom3_ff_int_type + pAngle_k_ijk + pAngle_k_kji

    MMFF94_Dihedral_Type_Record = pX_type_index + pAtom1_ff_int_type + pAtom2_ff_int_type + \
        pAtom3_ff_int_type + pAtom4_ff_int_type + pTors_V1 + pTors_V2 + pTors_V3

    MMFF94_OOP_Type_Record = pAtom1_ff_int_type + pAtom2_ff_int_type + \
        pAtom3_ff_int_type + pAtom4_ff_int_type + pDihedral_vphi
