...
def step1_workflow(data, _params, _plt):
    ...
    # ============ Make training data ====================
    ann_input_dim, training_input, training_target = make_training_data(
        data_transformed, training_steps, w_lead, tau, dt, deriv_scaling)

    # ============= Now save meta-information and the data ==========
    meta_info = {
        "ann_input_dim": ann_input_dim,
        "w_lead": w_lead,
        "tau": tau,
        "data_scaling": data_scaling,
        "data_shift": data_shift,
        "training_steps": training_steps,
        "training_input_n_rows": training_input.num_of_rows,
        "training_input_n_cols": training_input.num_of_cols,
        "training_target_n_rows": training_target.num_of_rows,
        "training_target_n_cols": training_target.num_of_cols}
