...
#                print "n=", "f[n]=",MOL[i].f[n]
            ...
            if snap >= Tstart:
                ...
                # this operation will also rescale velocities, if necessary
    ...
    f = open("relax.txt", "a")
    f.write(
        "snap= %5i  se_pop(0)= %8.5f  se_pop(1)= %8.5f  sh_pop(0)= %8.5f sh_pop(1)= %8.5f Etot[0]= %8.5f E0= %8.5f E1= %8.5f E01= %8.5f\n" %
        (snap,
         se_pops[0],
         se_pops[1],
         sh_pops[0],
