...
# p - means 'Pattern'
    ...
    GAFF_Atom_Type_Record = pAtom_type_keyword + pAtom_ff_int_type + \
        pAtom_ff_type + pAtom_sigma + pAtom_epsilon + pAtom_C_star + pAtom_Z_star
    GAFF_Bond_Type_Record = pAtom1_ff_type + CONNECTOR + pAtom2_ff_type + SP + pBond_k_bond + pBond_r_eq
    GAFF_Angle_Type_Record = pAtom1_ff_type + CONNECTOR + pAtom2_ff_type + \
        CONNECTOR + pAtom3_ff_type + SP + pAngle_k_angle + pAngle_theta_eq
    GAFF_Dihedral_Type_Record = pAtom1_ff_type + CONNECTOR + pAtom2_ff_type + CONNECTOR + \
        pAtom3_ff_type + CONNECTOR + pAtom4_ff_type + SP + pDihedral_mult + pDihedral_vphi + pDihedral_phase
