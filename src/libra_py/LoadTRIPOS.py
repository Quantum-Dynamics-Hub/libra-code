...
# p - means 'Pattern'
    ...
    TRIPOS_Atom_Type_Record = pAtom_ff_type + pAtom_val + pAtom_geom + \
        pAtom_Hbd + pAtom_Hba + pAtom_LP + pAtom_sigma + pAtom_epsilon
    ...
    TRIPOS_Dihedral_Type_Record = pAtom1_ff_type + pAtom2_ff_type + \
        pAtom3_ff_type + pAtom4_ff_type + pBond_bo + pDihedral_vphi + pDihedral_mult
