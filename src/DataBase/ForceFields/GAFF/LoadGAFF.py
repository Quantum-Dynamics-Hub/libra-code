...
def Load_GAFF(force_field):

    ff_file1 = "./DataBase/ForceFields/GAFF/gaff_types.dat" # In current directory
    ff_file2 = "./DataBase/ForceFields/GAFF/gaff_bonds.dat" # In current directory
    ff_file3 = "./DataBase/ForceFields/GAFF/gaff_angles.dat" # In current directory
    ff_file4 = "./DataBase/ForceFields/GAFF/gaff_dihedrals.dat" # In current directory
