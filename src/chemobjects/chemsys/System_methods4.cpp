...
/**
  ...
  \brief The file implements the function for determining functional group name
  for each given atom.
...
int System::is(std::string X, int n, int m, int sz, Atom **at,
               vector<Atom *> &which) {
  /**
  ...
  */
  ...
  for (int i = 0; i < sz; i++) {
    if (X == "OH") {
      if (at[i]->Atom_element == "O" &&
          at[i]->globAtom_Adjacent_Atoms.size() == 2) {
      ...
      if (at[i]->Atom_element == X && at[i]->globAtom_Adjacent_Atoms.size() ==
  ...
  */
  ...
  for (auto i = 0; i < Number_of_atoms; i++) {
    ...
    for (auto j = 0; j < sz1; j++) {
      at[j] = &Atoms[Atoms[i].globAtom_Adjacent_Atoms[j]];
    }
    ...
    if (Atoms[i].Atom_element == "C" && !Atoms[i].is_Atom_functional_group) {
      ...
      if (sz1 == 4) {
        func_grp = "Alkyl";
        if (is("O", 2, 2, sz1, at, w1)) {
          func_grp = "Ketal";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 2, 1, sz1, at, w1) && is("OH", 2, 1, sz1, at, w2)) {
          func_grp = "Hemiketal";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 2, 2, sz1, at, w1) && is("H", 1, 1, sz1, at, w2)) {
          func_grp = "Acetal";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        ...
        func_grp = "Alkenyl";
        if (is("O", 1, 1, sz1, at, w1)) {
          func_grp = "Carbonyl";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 1, 1, sz1, at, w1) && is("H", 1, 1, sz1, at, w2)) {
          func_grp = "Aldehyde";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 1, 1, sz1, at, w1) && is("F", 1, 1, sz1, at, w2)) {
          func_grp = "Haloformyl";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 1, 1, sz1, at, w1) && is("Cl", 1, 1, sz1, at, w2)) {
          func_grp = "Haloformyl";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 1, 1, sz1, at, w1) && is("Br", 1, 1, sz1, at, w2)) {
          func_grp = "Haloformyl";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 1, 1, sz1, at, w1) && is("I", 1, 1, sz1, at, w2)) {
          func_grp = "Haloformyl";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        ...
        if (is("O", 1, 1, sz1, at, w1) && is("O", 2, 2, sz1, at, w2)) {
          func_grp = "Carbonate_ester";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 1, 2, sz1, at, w1)) {
          func_grp = "Carboxylate";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 1, 1, sz1, at, w1) && is("O", 2, 1, sz1, at, w2)) {
          func_grp = "Ester";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 1, 1, sz1, at, w1) && is("OH", 2, 1, sz1, at, w2)) {
          func_grp = "Carboxyl";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        ...
        if (is("O", 1, 1, sz1, at, w1) && is("N", 3, 1, sz1, at, w2)) {
          func_grp = "Carboxamide";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("N", 2, 1, sz1, at, w1)) {
          func_grp = "Secondary_ketimine";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("NH", 2, 1, sz1, at, w1)) {
          func_grp = "Primary_ketimine";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("N", 2, 1, sz1, at, w1) && is("H", 1, 1, sz1, at, w2)) {
          func_grp = "Secondary_aldimine";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("NH", 2, 1, sz1, at, w1) && is("H", 1, 1, sz1, at, w2)) {
          func_grp = "Primary_aldimine";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }

        if (is("S", 1, 1, sz1, at, w1)) {
          func_grp = "Thione";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("S", 1, 1, sz1, at, w1) && is("H", 1, 1, sz1, at, w2)) {
          func_grp = "Thial";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        ...
        func_grp = "Alkynyl";
        if (is("N", 1, 1, sz1, at, w1)) {
          func_grp = "Nitrile";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("N", 1, 1, sz1, at, w1) && is("O", 2, 1, sz1, at, w2)) {
          func_grp = "Cyanate";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("N", 2, 1, sz1, at, w1) && is("O", 1, 1, sz1, at, w2)) {
          func_grp = "Isocyanate";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("N", 1, 1, sz1, at, w1) && is("S", 2, 1, sz1, at, w2)) {
          func_grp = "Thiocyanate";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("N", 2, 1, sz1, at, w1) && is("S", 1, 1, sz1, at, w2)) {
          func_grp = "Isothiocyanate";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
      ...
      for (auto j = 0u; j < W1.size(); j++) {
        all.push_back(W1[j]);
      }
      for (auto j = 0u; j < W2.size(); j++) {
        all.push_back(W2[j]);
      }
      for (auto j = 0u; j < W3.size(); j++) {
        all.push_back(W3[j]);
      }
  ...
  for (auto i = 0; i < Number_of_atoms; i++) {
    ...
    if (Atoms[i].Atom_element == "N" && !Atoms[i].is_Atom_functional_group) {
      ...
      if (sz1 == 4) {
        ...
        if (is("H", 1, 1, sz1, at, w1)) {
          func_grp = "Secondary_amine";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("H", 1, 2, sz1, at, w1)) {
          func_grp = "Primary_amine";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("C", 1, 2, sz1, at, w1)) {
          ...
          if (w1[0]->is_Atom_functional_group &&
              w1[1]->is_Atom_functional_group) {
            if (w1[0]->Atom_functional_group == "Carboxamide" &&
                w1[1]->Atom_functional_group == "Carboxamide") {
              func_grp = "Imide";
              store(w1, W1);
              store(w2, W2);
              store(w3, W3);
        ...
        if (is("O", 1, 2, sz1, at, w1) && is("O", 2, 1, sz1, at, w2)) {
          func_grp = "Nitrate";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        ...
        if (is("N", 1, 1, sz1, at, w1) && is("N", 2, 1, sz1, at, w2)) {
          func_grp = "Azide";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
  ...
  for (auto i = 0; i < Number_of_atoms; i++) {
    ...
    if (Atoms[i].Atom_element == "S" && !Atoms[i].is_Atom_functional_group) {
      ...
      if (sz1 == 2) {
        ...
        if (is("O", 1, 1, sz1, at, w1) && is("OH", 1, 1, sz1, at, w2)) {
          func_grp = "Sulfino";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        ...
        if (is("O", 1, 2, sz1, at, w1) && is("OH", 1, 1, sz1, at, w2)) {
          func_grp = "Sulfo";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("O", 1, 2, sz1, at, w1) && is("N", 3, 1, sz1, at, w2)) {
          func_grp = "Sulfonamide";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
  ...
  for (auto i = 0; i < Number_of_atoms; i++) {
    ...
    if (Atoms[i].Atom_element == "P" && !Atoms[i].is_Atom_functional_group) {
      ...
      if (sz1 == 4) {
        if (is("O", 1, 1, sz1, at, w1) && is("OH", 1, 2, sz1, at, w2)) {
          func_grp = "Phosphono";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
  ...
  for (auto i = 0; i < Number_of_atoms; i++) {
    ...
    if (Atoms[i].Atom_element == "O" && !Atoms[i].is_Atom_functional_group) {
      ...
      if (sz1 == 2) {
        ...
        if (is("O", 2, 1, sz1, at, w1)) {
          func_grp = "Peroxy";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
        if (is("OH", 2, 1, sz1, at, w1)) {
          func_grp = "Hydroperoxy";
          store(w1, W1);
          store(w2, W2);
          store(w3, W3);
        }
  ...
  for (auto i = 0; i < Number_of_atoms; i++) {
    ...
    //--------------- Hydrogen --------------------------
    if (Atoms[i].Atom_element ==
        "H" /*&& !Atoms[i].is_Atom_functional_group*/) {

      if (sz1 == 1) {
        func_grp =
            Atoms[Atoms[i].globAtom_Adjacent_Atoms[0]].Atom_functional_group;
        if (is("H", 1, 1, sz1, at, w1)) {
          func_grp = "Hydrogen";
          store(w1, W1);
          store(w2, W2);
        ...
        // Break ambiguity for hydrogens connected to different atoms in the
        // same functional group
        if (func_grp == "Sulfonamide") {
          if (is("N", 3, 1, sz1, at, w1)) {
            func_grp = "Sulfonamide_H_on_N";
          }
          if (is("S", 4, 1, sz1, at, w1)) {
            func_grp = "Sulfonamide_H_on_S";
          }
        } else if (func_grp == "Hemiacetal") {
          if (is("O", 2, 1, sz1, at, w1)) {
            func_grp = "Hemiacetal_H_on_O";
          }
          if (is("C", 4, 1, sz1, at, w1)) {
            func_grp = "Hemiacetal_H_on_C";
          }
        } else if (func_grp == "Primary_aldimine") {
          if (is("N", 2, 1, sz1, at, w1)) {
            func_grp = "Primary_aldimine_H_on_N";
          }
          if (is("C", 2, 1, sz1, at, w1)) {
            func_grp = "Primary_aldimine_H_on_C";
          }
        } else if (func_grp == "Imide") {
          if (is("N", 3, 1, sz1, at, w1)) {
            func_grp = "Imide_H_on_N";
          }
          if (is("C", 3, 1, sz1, at, w1)) {
            func_grp = "Imide_H_on_C";
          }
        } else if (func_grp == "Carboxamide") {
          if (is("N", 3, 1, sz1, at, w1)) {
            func_grp = "Carboxamide_H_on_N";
          }
          if (is("C", 3, 1, sz1, at, w1)) {
            func_grp = "Carboxamide_H_on_C";
          }
        }
  ...
  for (auto i = 0; i < Number_of_atoms; i++) {
    ...
    if (Atoms[i].is_Atom_functional_group) {
      cout << " belongs to the functional group= "
           << Atoms[i].Atom_functional_group << endl;
    } else {
