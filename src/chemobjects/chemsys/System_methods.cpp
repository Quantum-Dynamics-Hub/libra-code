...
/**
  ...
  \brief The file implements the search and info output methods of the System
  class
...
int System::get_atom_index_by_atom_id(int id) {
  /**
    ...
    \param[in] id The ID of the atom (note that this can be any integer, not
...
int System::get_fragment_index_by_fragment_id(int id) {
  /**
    \brief This auxiliary function returns the index of the fragment given the
    id of the fragment. If no fragment with given id were found -1 is returned.
    \param[in] id The ID of the fragment (note that this can be any integer, not
    necessarily sequential)
  */
...
int System::get_molecule_index_by_molecule_id(int id) {
  /**
    \brief This auxiliary function returns the index of the molecule given the
    id of the molecule. If no molecule with given id were found -1 is returned.
    \param[in] id The ID of the molecule (note that this can be any integer, not
    necessarily sequential)
  */
...
int System::Find_Bond(int at_indx1, int at_indx2) {
  ...
  */
  ...
  for (int i = 0; i < Number_of_bonds; i++) {
    if (((Bonds[i].globAtom_Index[0] == at_indx1) &&
         (Bonds[i].globAtom_Index[1] == at_indx2)) ||
        ((Bonds[i].globAtom_Index[0] == at_indx2) &&
         (Bonds[i].globAtom_Index[1] == at_indx1))) {
      res = i;
      break;
    }
  }
...
int System::Find_Frag_Pair(int at_indx1, int at_indx2) {
  ...
  */
  ...
  for (int i = 0; i < Number_of_frag_pairs; i++) {
    int fp = Frag_pairs[i];
    if (((Pairs[fp].globAtom_Index[0] == at_indx1) &&
         (Pairs[fp].globAtom_Index[1] == at_indx2)) ||
        ((Pairs[fp].globAtom_Index[0] == at_indx2) &&
         (Pairs[fp].globAtom_Index[1] == at_indx1))) {
      res = i;
      break;
    }
  }
...
int System::Find_Angle(int at_indx1, int at_indx3) {
  ...
  */
  ...
  for (int i = 0; i < Number_of_angles; i++) {
    if (((Angles[i].globAtom_Index[0] == at_indx1) &&
         (Angles[i].globAtom_Index[2] == at_indx3)) ||
        ((Angles[i].globAtom_Index[0] == at_indx3) &&
         (Angles[i].globAtom_Index[2] == at_indx1))) {
      res = i;
      break;
    }
  }
...
int System::Find_Angle(int at_indx1, int at_indx2, int at_indx3) {
  ...
  */
  ...
  for (int i = 0; i < Number_of_angles; i++) {
    if (((Angles[i].globAtom_Index[0] == at_indx1) &&
         (Angles[i].globAtom_Index[1] == at_indx2) &&
         (Angles[i].globAtom_Index[2] == at_indx3)) ||
        ((Angles[i].globAtom_Index[0] == at_indx3) &&
         (Angles[i].globAtom_Index[1] == at_indx2) &&
         (Angles[i].globAtom_Index[2] == at_indx1))) {
...
int System::Find_Dihedral(int at_indx1, int at_indx2, int at_indx3,
                          int at_indx4) {
  /**
...
int System::Find_Improper(int at_indx1) {
  /**
    \param[in] at_indx1 The index of the central atom to which 3 other atoms are
    connected This class System method is looking for an improper with a central
    atom having index at_indx1 It returns globGroup_Index of corresponding
    improper
  */

  int res = -1;
  for (int i = 0; i < Number_of_impropers; i++) {
    if (Impropers[i].globAtom_Index[0] == at_indx1) {
      res = i;
      break;
    }
  }
...
int System::is_12pair(int at_indx1, int at_indx2) {
  ...
  */
  ...
  int res = 0;
  for (auto i = 0u; i < Atoms[at_indx1].globAtom_Adjacent_Atoms.size(); i++) {
    if (Atoms[at_indx1].globAtom_Adjacent_Atoms[i] == at_indx2) {
      res = 1;
    }
  }
  return res;
...
int System::is_13pair(int at_indx1, int at_indx2) {
  ...
  */
  ...
  int res = 0;
  for (auto i = 0u; i < Atoms[at_indx1].globAtom_Adjacent_Atoms.size(); i++) {
    for (auto j = 0u; j < Atoms[at_indx2].globAtom_Adjacent_Atoms.size(); j++) {
      if (Atoms[at_indx1].globAtom_Adjacent_Atoms[i] ==
          Atoms[at_indx2].globAtom_Adjacent_Atoms[j]) {
        res = 1;
      }
    }
  }
...
int System::is_14pair(int at_indx1, int at_indx2) {
  ...
  */
  ...
  for (auto i = 0u; i < Atoms[at_indx1].globAtom_Adjacent_Atoms.size(); i++) {
    for (auto j = 0u; j < Atoms[at_indx2].globAtom_Adjacent_Atoms.size(); j++) {
      if (is_12pair(Atoms[at_indx1].globAtom_Adjacent_Atoms[i],
                    Atoms[at_indx2].globAtom_Adjacent_Atoms[j])) {
        res = 1;
      }
    }
...
void System::show_frag_angles() {
  ...
  */
  ...
  for (int i = 0; i < Number_of_frag_angles; i++) {
    Angles[Frag_angles[i]].show_info();
  }
}
...
void System::show_frag_dihedrals() {
  ...
  */
  ...
  for (int i = 0; i < Number_of_frag_dihedrals; i++) {
    Dihedrals[Frag_dihedrals[i]].show_info();
  }
}
...
void System::show_frag_impropers() {
  ...
  */
  ...
  for (int i = 0; i < Number_of_frag_impropers; i++) {
    Impropers[Frag_impropers[i]].show_info();
  }
}
