...
public:
  std::string Elt_name;           int is_Elt_name;   // actually it is an element symbol
  int         Elt_id;             int is_Elt_id;     // Usually is the same as Elt_number
  double      Elt_mass;           int is_Elt_mass;
  int         Elt_number;         int is_Elt_number; // In periodic table of elements
  int         Elt_nucleus_charge; int is_Elt_nucleus_charge;
  int         Elt_period;         int is_Elt_period; // in periodic table of elements
  int         Elt_group;          int is_Elt_group;  // in periodic table of elements
  std::string Elt_block;          int is_Elt_block;  // S, P, D or F
  int         Elt_red;            int is_Elt_red;
  int         Elt_green;          int is_Elt_green; 
  int         Elt_blue;           int is_Elt_blue;
