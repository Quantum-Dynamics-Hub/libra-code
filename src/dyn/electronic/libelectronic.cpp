...
*/
  ...
  void (*expt_propagate_electronic_nonorth_v1)(double dt, CMATRIX& Coeff, CMATRIX& Hvib, CMATRIX& S) = &propagate_electronic_nonorth;
  ...
  def("propagate_electronic_nonorth", expt_propagate_electronic_nonorth_v1);
