...
void export_dyn_variables_objects(){
  ...
  class_<dyn_variables>("dyn_variables",init<int, int, int, int>())
      ...
      .def_readwrite("nstates", &dyn_variables::nstates)
      .def_readwrite("ndof", &dyn_variables::ndof)
      .def_readwrite("nnucl", &dyn_variables::nnucl)
      .def_readwrite("ntraj", &dyn_variables::ntraj)
      .def_readwrite("nbeads", &dyn_variables::nbeads)
      .def_readwrite("nphot", &dyn_variables::nphot)
      ...
      .def_readwrite("t_ampl_adi", &dyn_variables::t_ampl_adi)
      .def_readwrite("t_ampl_dia", &dyn_variables::t_ampl_dia)
      .def_readwrite("t_q_elec", &dyn_variables::t_q_elec)
      .def_readwrite("t_p_elec", &dyn_variables::t_p_elec)
      .def_readwrite("t_proj_adi", &dyn_variables::t_proj_adi)
      .def_readwrite("t_dm_dia", &dyn_variables::t_dm_dia)
      .def_readwrite("t_dm_adi", &dyn_variables::t_dm_adi) 
      .def_readwrite("t_act_states_adi", &dyn_variables::t_act_states_adi)
      .def_readwrite("t_act_states_dia", &dyn_variables::t_act_states_dia)
      .def_readwrite("t_basis_transform", &dyn_variables::t_basis_transform)

      .def_readwrite("nuclear_vars_status", &dyn_variables::nuclear_vars_status)
      .def_readwrite("t_iM", &dyn_variables::t_iM)
      .def_readwrite("t_q_nucl", &dyn_variables::t_q_nucl)
      .def_readwrite("t_p_nucl", &dyn_variables::t_p_nucl)
      .def_readwrite("t_f_nucl", &dyn_variables::t_f_nucl)

      .def_readwrite("photonic_vars_status", &dyn_variables::photonic_vars_status)
      .def_readwrite("t_q_phot", &dyn_variables::t_q_phot)
      .def_readwrite("t_p_phot", &dyn_variables::t_p_phot)
      .def_readwrite("t_f_phot", &dyn_variables::t_f_phot)
      ...
      .def("allocate_photonic_vars", &dyn_variables::allocate_photonic_vars)
