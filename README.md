...
This code is provided in the hope it will be useful. 
  ...
  * [Phase correction, Ehrenfest dynamics details, basis transformations (see the SI)]
  Akimov, A. V.; "A Simple Phase Correction Makes a Big Difference in Nonadiabatic Molecular Dynamics"
  *J. Phys. Chem. Lett.*  **2018** 9, 6096-6102 [link](https://doi.org/10.1021/acs.jpclett.8b02826)
