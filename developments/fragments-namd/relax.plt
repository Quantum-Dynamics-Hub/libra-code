...
set output "_populations_sh.png"
plot "_populations_sh.txt" using 2:($10+$11)        w p  ls 11  lw 1  t "P(SubPc), calculated",\
     "_populations_sh.txt_model.txt" using 1:($2) w l  ls 11  lw 3  t "P(SubPc), fit"
