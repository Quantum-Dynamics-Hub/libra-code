...
set ylabel "Pressure, a.u." offset 1.5, 0.0 
set output "_md_press.png"
plot "_en_md.txt" using 2:14   w l  ls 11  lw 5  t "Pressure"

set ylabel "Volume, a.u." offset 1.5, 0.0 
set output "_md_vol.png"
plot "_en_md.txt" using 2:16   w l  ls 11  lw 5  t "Volume"
