...
set output "acf_mu.png"
plot "acf_mu.txt" using 1:2 w l ls 11 lw 5 t "dip. mom. ACF"

set output "acf_vel.png"
plot "acf_vel.txt" using 1:2 w l ls 11 lw 5 t "velocity ACF"
...
plot "spectrum_mu.txt" using ($1):($2*$2) w l ls 11 lw 5 t "dip. mom. ACF spectrum",\
     "spectrum_vel.txt" using ($1):($2*$2) w l ls 21 lw 5 t "velocity ACF spectrum"
