...
set output "_en_cooling1.png"
plot "_en_cooling1.txt" using 2:4   w lp  ls 11  lw 2  t "E_{kin}",\
     "_en_cooling1.txt" using 2:6   w lp  ls 21  lw 2  t "E_{pot}",\
     "_en_cooling1.txt" using 2:8   w lp  ls 31  lw 2  t "E_{tot}"

set xlabel "time, steps" offset 0.0, 0.5
set ylabel "Energy, a.u." offset 1.5, 0.0
set output "_en_cooling2.png"
plot "_en_cooling2.txt" using 2:4   w lp  ls 11  lw 2  t "E_{kin}",\
     "_en_cooling2.txt" using 2:6   w lp  ls 21  lw 2  t "E_{pot}",\
     "_en_cooling2.txt" using 2:8   w lp  ls 31  lw 2  t "E_{tot}"


set xlabel "time, steps" offset 0.0, 0.5
set ylabel "Energy, a.u." offset 1.5, 0.0
set output "_en_md.png"
plot "_en_md.txt" using 2:4   w lp  ls 11  lw 2  t "E_{kin}",\
     "_en_md.txt" using 2:6   w lp  ls 21  lw 2  t "E_{pot}",\
     "_en_md.txt" using 2:8   w lp  ls 31  lw 2  t "E_{tot}",\
     "_en_md.txt" using 2:10  w lp  ls 41  lw 2  t "E_{NP}"


set xlabel "time, steps" offset 0.0, 0.5
set ylabel "Energy, a.u." offset 1.5, 0.0
set output "_temp_md.png"
plot "_en_md.txt" using 2:12   w lp  ls 11  lw 2  t "T_{curr}"
