...
set output "3D_kin_nucl.png"
plot "3D_kin_nucl.txt" using 1:2  w l  ls 11  lw 5  t "<s(A)| T + V |s(B)>",\
     "3D_kin_nucl.txt" using 1:3  w l  ls 12  lw 5  t "<s(A)| T + V |px(B) >",\
     "3D_kin_nucl.txt" using 1:4  w l  ls 13  lw 5  t "<px(A)| T + V |px(B)>",\
     "3D_kin_nucl.txt" using 1:5  w l  ls 14  lw 5  t "<px(A)| T + V |py(B)>",\
     "3D_kin_nucl.txt" using 1:6  w l  ls 21  lw 5  t "<f(A)| T + V | f(B)>"
