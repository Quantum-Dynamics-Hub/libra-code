...
set output "relax.png"
plot "relax.txt" using 2:6   w lp  ls 11  lw 2  t "P(1), SE"


set xlabel "time, steps" offset 0.0, 0.5
set ylabel "Energy, Ha" offset 1.5, 0.0
set output "relax_energy.png"
plot "relax.txt" using 2:14   w lp  ls 11  lw 2  t "E_0",\
     "relax.txt" using 2:16   w lp  ls 31  lw 2  t "E_1"


set xlabel "time, steps" offset 0.0, 0.5
set ylabel "NAC, Ha" offset 1.5, 0.0
...
set xlabel "time, steps" offset 0.0, 0.5
set ylabel "Dihedral" offset 1.5, 0.0
set output "dihedral.png"
plot "dihedral.txt" using 1:2   w lp  ls 11  lw 2  t "Dihedral"
