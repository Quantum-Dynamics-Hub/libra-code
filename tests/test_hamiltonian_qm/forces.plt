...
set ylabel "Gradients, a.u." offset 1.5, 0.0
set output "forces.png"
plot "forces.txt" using 2:5   w lp  ls 11  lw 2  t "Numerical",\
     "forces.txt" using 2:8   w lp  ls 21  lw 2  t "Analytic"

set xlabel "time, steps" offset 0.0, 0.5
set ylabel "Energy, a.u." offset 1.5, 0.0
set output "energies.png"
plot "forces.txt" using 2:10  w lp  ls 11  lw 2  t "Energy"
