...
set ylabel "Energy and DC, a.u." offset 1.5, 0.0
set output "forces_ex1.png"
plot "forces_ex1.txt" using 1:2   w lp  ls 11  lw 2  t "E_0",\
     "forces_ex1.txt" using 1:3   w lp  ls 11  lw 2  t "E_1",\
     "forces_ex1.txt" using 1:4   w lp  ls 11  lw 2  t "E_2",\
     "forces_ex1.txt" using 1:($8*0.1)   w l   ls 12  lw 2  t "d01",\
     "forces_ex1.txt" using 1:($9*0.1)   w l   ls 22  lw 2  t "d02",\
     "forces_ex1.txt" using 1:($10*0.0)  w l   ls 32  lw 2  t "d12"
