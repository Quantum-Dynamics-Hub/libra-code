...
plot "p_scatt_tr_fssh.txt" using 2:8   w p  ls 31  lw 2  t "SH(0), FSSH",\
     "p_scatt_tr_fssh.txt" using 2:10  w p  ls 32  lw 2  t "SH(1), FSSH",\
     "res.dat" using 1:3  w l  ls 31 lw 2 t "SH(0), FSSH reference",\
     "res.dat" using 1:5  w l  ls 32 lw 2 t "SH(1), FSSH reference",\
     "p_scatt_tr_esh.txt" using 2:8   w l  ls 11  lw 3  t "SH(0), ESH",\
     "p_scatt_tr_esh.txt" using 2:10  w l  ls 12  lw 3  t "SH(1), ESH"
...
plot "p_scatt_re_fssh.txt" using 2:8   w p  ls 31  lw 2  t "SH(0), FSSH",\
     "p_scatt_re_fssh.txt" using 2:10  w p  ls 32  lw 2  t "SH(1), FSSH",\
     "res.dat" using 1:4  w l  ls 31 lw 2 t "SH(0), FSSH reference",\
     "res.dat" using 1:6  w l  ls 32 lw 2 t "SH(1), FSSH reference",\
     "p_scatt_re_esh.txt" using 2:8   w l  ls 11  lw 3  t "SH(0), ESH",\
     "p_scatt_re_esh.txt" using 2:10  w l  ls 12  lw 3  t "SH(1), ESH"
