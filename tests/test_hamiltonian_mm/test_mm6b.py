...
# Test setting initial velocities and angular momenta
###################################################################
...
def md_step_free(syst, mol, el, ham, dt, integrator):
# Integration of free motion (no internal forces)
