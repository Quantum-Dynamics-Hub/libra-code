...
set xrange [-0:15]
set output "_wfc-x.png"
set xlabel "Coordinate (a.u)" offset 0.0, 0.5
set ylabel "Amplitude (a.u)" offset 2.2, 0.0
plot  "_out.txt" u ($1):3 w l ls 11 lw 5 t "Real G", \
      "_out.txt" u ($1):4 w l ls 21 lw 5 t "Imag G", \
      "_out.txt" u ($1):($3*$3+$4*$4) w l ls 32 lw 5 t "|G|^2"


set output "_wfc.state0.frame0.png"
set xlabel "Coordinate (a.u)" offset 0.0, 0.5
set ylabel "Amplitude (a.u)" offset 2.2, 0.0
plot  "_wfc.state0.frame0" u ($1):2 w l ls 11 lw 5 t "|G|^2"


set output "_wfc-px.png"
set xlabel "Momentum (a.u)" offset 0.0, 0.5
set ylabel "Amplitude (a.u)" offset 2.2, 0.0
plot  "_out.txt" u ($2):5 w l ls 11 lw 5 t "Real G", \
      "_out.txt" u ($2):6 w l ls 21 lw 5 t "Imag G", \
      "_out.txt" u ($2):($5*$5+$6*$6) w l ls 32 lw 5 t "|G|^2"


set output "_reci_wfc.state0.frame0.png"
set xlabel "Momentum (a.u)" offset 0.0, 0.5
set ylabel "Amplitude (a.u)" offset 2.2, 0.0
plot  "_reci_wfc.state0.frame0" u ($1):2 w l ls 11 lw 5 t "|G|^2"
