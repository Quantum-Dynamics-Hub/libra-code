...
plot "_0_new.txt" using 1:10   w l  ls 11  lw 5  t "P(0)",\
     "_0_new.txt" using 1:11   w l  ls 21  lw 5  t "P(1)"

set output "_pop_dia.png"
plot "_0_new.txt" using 1:12   w l  ls 11  lw 5  t "P(0)",\
     "_0_new.txt" using 1:13   w l  ls 21  lw 5  t "P(1)"


set output "_pop_sh.png"
plot "_0_new.txt" using 1:14   w l  ls 11  lw 5  t "P(0)"
