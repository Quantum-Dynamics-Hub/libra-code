...
set output "_acf.png"
plot "_acf.txt" using 1:6 w l ls 11 t "Re(C)",\
     "_acf.txt" using 1:7 w l ls 11 t "Im(C)",\
     "_acf.txt" using 1:8 w l ls 11 t "Re(integ)",\
     "_acf.txt" using 1:9 w l ls 11 t "Im(integ)"
