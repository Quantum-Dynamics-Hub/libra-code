...
# Now, we consider mixing of spatial components of the alpha and beta 
# channels - due to spin-orbit coupling
###################################################################
...
#mo_pool_alp.set(1,1, c1+s1, 0.0);    mo_pool_bet.set(1,1, -s1+c1, 0.0);
#mo_pool_alp.set(2,2, c2+s2, 0.0);    mo_pool_bet.set(2,2, -s2+c2, 0.0);

mo_pool_alp.set(1,1, c1+s1, 0.0);    mo_pool_bet.set(1,1, c2+s2, 0.0);
mo_pool_alp.set(2,2,-s1+c1, 0.0);    mo_pool_bet.set(2,2, -s2+c2, 0.0);
