...
set output "sto-3g_2s.png"
plot "sto-3g_2s.txt" using 1:2  w l  ls 11  lw 5  t "3GTO, ksi = 1.3",\
     "sto-3g_2s.txt" using 1:3  w p  ls 11  lw 5  t "STO, ksi = 1.3",\
     "sto-3g_2s.txt" using 1:4  w l  ls 22  lw 5  t "3GTO, ksi = 2.6",\
     "sto-3g_2s.txt" using 1:5  w p  ls 22  lw 5  t "STO, ksi = 2.6"


set output "sto-3g_2p.png"
plot "sto-3g_2p.txt" using 1:2  w l  ls 11  lw 5  t "3GTO, ksi = 1.3",\
     "sto-3g_2p.txt" using 1:3  w p  ls 11  lw 5  t "STO, ksi = 1.3",\
     "sto-3g_2p.txt" using 1:4  w l  ls 22  lw 5  t "3GTO, ksi = 2.6",\
     "sto-3g_2p.txt" using 1:5  w p  ls 22  lw 5  t "STO, ksi = 2.6"
