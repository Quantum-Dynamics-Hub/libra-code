...
set ylabel "3D moments" offset 1.5, 0.0 

set output "moments.png"
plot "moments.txt" using 1:2  w l  ls 11  lw 5  t "<s|s>",\
     "moments.txt" using 1:3  w p  ls 11  lw 5  t "<s|p>",\
     "moments.txt" using 1:4  w l  ls 22  lw 5  t "<s|x|s>",\
     "moments.txt" using 1:5  w p  ls 22  lw 5  t "<s|x|p>"
