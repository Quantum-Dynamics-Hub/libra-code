...
set output "ham_sexch.png"
plot "H_00.txt" using 1:3  w l  ls 11  lw 5  t "H_{00}",\
     "H_01.txt" using 1:3  w lp ls 21  lw 3  t "H_{01}",\
     "H_02.txt" using 1:3  w l  ls 31  lw 5  t "H_{02}",\
     "H_11.txt" using 1:3  w l  ls 12  lw 5  t "H_{11}",\
     "H_12.txt" using 1:3  w l  ls 32  lw 5  t "H_{12}",\
     "H_22.txt" using 1:3  w l  ls 41  lw 5  t "H_{22}"
