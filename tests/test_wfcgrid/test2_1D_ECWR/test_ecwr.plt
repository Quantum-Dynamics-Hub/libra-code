...
set output "ham_ecwr.png"
plot "H_00.txt" using 1:3  w l  ls 11  lw 5  t "H_{00}",\
     "H_01.txt" using 1:3  w l  ls 21  lw 5  t "H_{01}",\
     "H_11.txt" using 1:3  w l  ls 31  lw 5  t "H_{11}"


set output "Re_expH_ecwr.png"
plot "expH_00.txt" using 1:3  w l  ls 11  lw 5  t "Re(expH_{00})",\
     "expH_01.txt" using 1:3  w l  ls 21  lw 5  t "Re(expH_{01})",\
     "expH_11.txt" using 1:3  w l  ls 31  lw 5  t "Re(expH_{11})"

set output "Im_expH_ecwr.png"
plot "expH_00.txt" using 1:4  w l  ls 11  lw 5  t "Im(expH_{00})",\
     "expH_01.txt" using 1:4  w l  ls 21  lw 5  t "Im(expH_{01})",\
     "expH_11.txt" using 1:4  w l  ls 31  lw 5  t "Im(expH_{11})"


set output "Re_expK_ecwr.png"
plot "expK_00.txt" using 2:3  w l  ls 11  lw 5  t "Re(expK_{00})",\
     "expK_11.txt" using 2:3  w l  ls 31  lw 5  t "Re(expK_{11})"

set output "Im_expK_ecwr.png"
plot "expK_00.txt" using 2:4  w l  ls 11  lw 5  t "Im(expK_{00})",\
     "expK_11.txt" using 2:4  w l  ls 31  lw 5  t "Im(expK_{11})"
