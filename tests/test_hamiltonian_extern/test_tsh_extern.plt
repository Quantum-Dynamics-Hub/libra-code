...
plot "_tsh_extern.txt" using 2:8   w l  ls 11  lw 5  t "Ekin",\
     "_tsh_extern.txt" using 2:10  w l  ls 21  lw 5  t "Epot",\
     "_tsh_extern.txt" using 2:12  w l  ls 32  lw 5  t "Etot"
...
plot "_tsh_extern.txt" using 2:14  w l  ls 11  lw 5  t "|c0|^2",\
     "_tsh_extern.txt" using 2:16  w l  ls 21  lw 5  t "|c1|^2",\
     "_tsh_extern.txt" using 2:18  w l  ls 32  lw 5  t "Re(c01)"
...
plot "_tsh_extern.txt" using 2:20   w p  ls 11  lw 3  t "istate"
