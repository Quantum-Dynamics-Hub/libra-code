...
set ylabel "x" offset 1.5, 0.0
set output "_x_t.png"
plot "verlet.txt" using 1:2  w l  ls 11  lw 5  t "x-t"

set output "_E_t.png"
plot "verlet.txt" using 1:3  w l  ls 11  lw 5  t "E_dia",\
     "verlet.txt" using 1:4  w l  ls 21  lw 5  t "E_adi",\
     "verlet.txt" using 1:5  w l  ls 31  lw 5  t "E_tot"
