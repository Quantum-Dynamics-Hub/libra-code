...
plot sprintf("relax%d.txt",counter)  using ($1):($2)  w p   ls  21   lw 3  t "FSSH/GFSH",\
     sprintf("relax%d_mssh.txt",counter)  using ($1):($2)  w p   ls  32   lw 3  t "MSSH",\
     "exact.txt"  using ($2*25):($4)   w p   ls  11   lw 3  t "exact",\
