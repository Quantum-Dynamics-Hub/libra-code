...
plot "p_scatt_tr_fssh.txt" using 2:8   w l  ls 31  lw 2  t "SH(0), FSSH",\
     "p_scatt_tr_fssh.txt" using 2:10  w l  ls 32  lw 2  t "SH(1), FSSH",\
     "p_scatt_tr_esh.txt" using 2:8   w l  ls 11  lw 3  t "SH(0), ESH",\
     "p_scatt_tr_esh.txt" using 2:10  w l  ls 12  lw 3  t "SH(1), ESH",\
     "exact.txt" using 1:($5/($3+$5+$7+$9)) w p   lw 1  t "exact(0)",\
     "exact.txt" using 1:($9/($3+$5+$7+$9)) w p   lw 1  t "exact(1)"
...
plot "p_scatt_re_fssh.txt" using 2:8   w l  ls 31  lw 2  t "SH(0), FSSH",\
     "p_scatt_re_fssh.txt" using 2:10  w l  ls 32  lw 2  t "SH(1), FSSH",\
     "p_scatt_re_esh.txt" using 2:8   w l  ls 11  lw 3  t "SH(0), ESH",\
     "p_scatt_re_esh.txt" using 2:10  w l  ls 12  lw 3  t "SH(1), ESH",\
     "exact.txt" using 1:($3/($3+$5+$7+$9)) w p   lw 1  t "exact(0)",\
     "exact.txt" using 1:($7/($3+$5+$7+$9)) w p   lw 1  t "exact(1)"
