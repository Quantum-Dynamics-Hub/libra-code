...
def run_test2(output_1, output_2, output_3):
    """
    ...
    treating quantum nuclear effects" J. Chem. Phys. 148, 144106 (2018) 

    Note: the original calculations were performed in a purely Python-implemented
    code. Now the method is re-implemented in C++ and re-exposed to Python
    """
    ...
    rnd = Random()
    # We only set up the position matrix here, becuase we are  going to manually assign trajectories based
    # on the distributions used in the original ETHD paper.
    q = MATRIX(nnucl,ntraj);  #sample(q, mean_q, sigma_q, rnd)
    p = MATRIX(nnucl,ntraj);  sample(p, mean_p, sigma_p, rnd)
    
    # The following coordinates are used in the original ETHD paper in the symmetric double well model for ntraj = 100:
    qq = [-1.09854, -1.12192, -1.09621, -1.05124, -1.16032, -1.06631, -1.13264,
          -1.08911, -1.13068, -1.12903, -1.16492, -1.13773, -1.06396, -1.11805,
          -1.09131, -1.16439, -1.19177, -1.08141, -1.17604, -1.09649, -1.12952,
          -1.11991, -1.11633, -1.14776, -1.12007, -1.05910, -1.13377, -1.10087,
          -1.08388, -1.13641, -1.15817, -1.08500, -1.07592, -1.08342, -1.04719,
          -1.08480, -1.12494, -1.15889, -1.08761, -1.13408, -1.06406, -1.08297,
          -1.1232, -1.09591, -1.08338, -1.05569, -1.03208, -1.13144, -1.13133,
          -1.10966, -1.07806, -1.1481, -1.04755, -1.13187, -1.07395, -1.06856,
          -1.18011, -1.15939, -1.13139, -1.05896, -1.17767, -1.08951, -1.03073,
          -1.05692, -1.122, -1.17254, -1.14556, -1.08375, -1.11523, -1.08684,
          -1.13929, -1.07307, -1.11072, -1.06146, -1.09339, -1.10263, -1.04003,
          -1.15927, -1.07781, -1.11834, -1.10949, -0.99579, -1.07997, -1.0763,
          -1.16783, -1.11118, -1.18549, -1.09557, -1.09824, -1.09558, -1.11735,
          -1.113, -1.17004, -1.09844, -1.14848, -1.10039, -1.11218, -1.01426,
          -1.10208, -1.03295]

    # For each trajectory in qq, we will assign it to the position matrix q. 
    # Recall here we are doing 1D ETHD, so we populate only row 0.
    ...
    for i in xrange(500):
        ...
        # Count how many trajectories have crossed the dividing surface
        # located at q = 0.0  (the barrier of the symmetric double well potential)
        barrier = 0.0
...
run_test2("_output.txt","_phase_space.txt","_pos_space.txt")
