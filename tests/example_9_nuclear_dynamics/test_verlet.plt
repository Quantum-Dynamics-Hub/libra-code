...
set output "_t-q_new.png"
plot "_0_new.txt" using 1:2   w l  ls 11  lw 5  t "t-q"

set xlabel "t" offset 0.0, 0.5
set ylabel "p" offset 1.5, 0.0 
set output "_t-p_new.png"
plot "_0_new.txt" using 1:3   w l  ls 11  lw 5  t "t-p"


set xlabel "q" offset 0.0, 0.5
set ylabel "p" offset 1.5, 0.0 
set output "_q-p_new.png"
plot "_0_new.txt" using 2:3   w l  ls 11  lw 5  t "q-p"
